<?php
	...
	$rpta.="	<tr>
					...
					<td colspan='2'>
						<input type='text' class='form-control' id='dni_new' onkeypress='return valida2(event)'>
					</td>
				</tr>
				<tr>
					<td><strong>NOMBRES</strong></td>
					<td colspan='2'>
						<input type='text' class='form-control' id='nombres_new'>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan='2'>
						<input type='text' class='form-control' id='apellidos_new'>
					</td>
				</tr>
			";			
   ...
   $rpta .="<tr>
	...
	$rpta .="		<select class='form-control' id='cargo' name='cargo'>
						<option value='X' selected>- Elija Cargo -</option>";
						while($fila = mysql_fetch_array($result))
	                     {								
