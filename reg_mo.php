  ...
  <script type="text/javascript">
        ...
        function del_row(fila){
            $.confirm({
                ...
                boxWidth: '40%',
                useBootstrap: false,
                content: '¿ Borrar Registro de Mano de Obra ?',
                buttons: {
                    Si: {
                        text: 'Sí, Borrarlo', 
                        btnClass: 'btn-red',
                              ...
                              $.post('valida_addrow_n.php',
                                ...
                                function(datos) {  
                                    if(datos.encontrado == "S"){
                                          ...
                                          $.alert('No Existe esa OT o no esta ACTIVA');
                                          return;
                                    }
        ...
        function editar(id_mobra){
            ...
            $.post('editar_mo.php',
              ...
              function(datos) {  
                  ...
                  $("#fecha_ed").datepicker();
                  $('#btn_grabar_mo').attr("disabled", false); 
            },"json");            
        }
              ...
              if ($("#fecha_ed").val() == ""){
                  ...
                  if ($("#tarea_ed").val() == ""){
                      ...
                      $("#tarea_ed").focus();
                          ...
                          console.log("idfila "+$("#id_fila").val());
                          console.log("no_ot"+$("#var_no_ot").val());
