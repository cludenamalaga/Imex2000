<?php
	...
	$sql = "select * from ots where no_ot = '".$ot."'";
		...
		$jsondata['fila'] = '<tr id="'.$id.'">
								   ...
								   '</td>
                                    ...
                                    <td class="text-center">
                                    	<button type="button" class="btn btn-success btn-sm" onclick="consultar('.$id_.')" data-toggle="modal" data-target="#ver_mo"><span class="glyphicon glyphicon-search"></span></button>
                                    	<button type="button" class="btn btn-warning btn-sm" onclick="editar('.$id.')" data-toggle="modal" data-target="#edit_mo"><span class="glyphicon glyphicon-edit"></span></button>
